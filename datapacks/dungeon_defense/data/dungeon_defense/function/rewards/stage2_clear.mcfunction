give @s paper[minecraft:custom_name='{"text":"3단계 던전 토큰","color":"red","bold":true}',minecraft:lore=['{"text":"최종 단계","color":"dark_red"}'],minecraft:custom_data={dungeon_token:3}] 1
